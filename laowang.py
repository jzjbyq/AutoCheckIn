...
[rewrite_local]
https://www.laowang555.com url script-request-header https://raw.githubusercontent.com/jzjbyq/AutoCheckIn/main/laowangziyuan.py
"""
...
def start(ck):
    ...
    for i in payload:
        ...
        try:
            res = requests.get('https://www.laowang555.com/wp-admin/admin-ajax.php', params=params, headers=headers)
        ...
        # 获取当前积分数
        try:
            res = requests.get('https://www.laowang555.com/user/balance', headers=headers)
