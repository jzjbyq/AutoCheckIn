...
def start(postdata):
    ...
    for index, i in enumerate(payload):
        ...
        try:
            ...
            response = requests.request("POST", 'https://www.rfidfans.com/upload/qiandao.php', headers=headers, data=p,
...
def get_glod(name, pwd):
    ...
    try:
        res = requests.request("POST", 'https://www.rfidfans.com/upload/info_search.php', headers=headers, data=p,
